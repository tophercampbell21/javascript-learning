...
if (dolphinsAvgScore > koalasAvgScore && dolphinsAvgScore > minimumScore) {
  console.log(
    `Dolphins win with an average score of ${dolphinsAvgScore} over the Koalas' ${koalasAvgScore}`
  );
} else if (koalasAvgScore > dolphinsAvgScore && koalasAvgScore > minimumScore) {
  console.log(
    `Koalas win with an average score of ${koalasAvgScore} over the Dolphins' ${dolphinsAvgScore}`
  );
} else if (
  ...
  console.log(
    `It's a draw! Both teams scored an average of ${dolphinsAvgScore}`
  );
} else {
  console.log(
    "Neither team scored above the Minimum Score of 100, and thereore lose automatically"
  );
}
